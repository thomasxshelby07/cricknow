...
import { Star, CheckCircle, ArrowRight, ChevronLeft, ChevronRight, Trophy } from "lucide-react";
...
interface PremiumBettingSiteListClientProps {
    sites: BettingSite[];
...
export function PremiumBettingSiteListClient({ sites, showEmptyState = true }: PremiumBettingSiteListClientProps) {
                ...
                {totalPages > 1 && (
                    <div className="mt-8 flex items-center justify-center gap-4">
                        <Button
                            ...
                            variant="outline"
                            className="flex items-center gap-2 px-6 py-5 font-bold border-gray-300 dark:border-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-900 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg"
                        >
                            <ChevronLeft className="w-4 h-4" />
                            Previous
                        </Button>

                        <div className="flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-neutral-900 rounded-lg border border-gray-200 dark:border-neutral-800">
                            <span className="text-sm font-bold text-gray-600 dark:text-gray-400">
                                Page <span className="text-black dark:text-white">{currentPage}</span> of <span className="text-black dark:text-white">{totalPages}</span>
                            </span>
                        </div>
